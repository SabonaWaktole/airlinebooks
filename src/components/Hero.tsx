...
export const Hero: React.FC = () => {
  ...
  return (
    <div>
      {/* Alliance Banner */}
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-blue-700 to-emerald-600">
        <div className="absolute inset-0 bg-black/20"></div>
        
        {/* Decorative elements */}
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="absolute top-4 left-10 w-16 h-16 bg-white/10 rounded-full blur-xl"></div>
          <div className="absolute bottom-4 right-10 w-20 h-20 bg-white/10 rounded-full blur-xl"></div>
          <div className="absolute top-1/2 left-1/4 w-12 h-12 bg-white/10 rounded-full blur-xl"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div className="flex-shrink-0">
              <img
                src="https://rjiozcbtszmyehzffzpa.supabase.co/storage/v1/object/public/imagebooks//kidairlinenordic.jpg"
                alt="Ethiopian Airlines & Nordic ICT Alliance"
                className="h-16 lg:h-20 w-auto object-contain rounded-lg shadow-lg bg-white/10 backdrop-blur-sm p-2"
              />
            </div>
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start space-x-3 mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-white font-semibold">Ethiopian Airlines</span>
                </div>
                <span className="text-white/70">×</span>
                <div className="flex items-center space-x-2">
                  <Globe className="w-5 h-5 text-white" />
                  <span className="text-white font-semibold">Nordic ICT</span>
                </div>
              </div>
              <p className="text-white/90 text-sm lg:text-base leading-relaxed max-w-2xl">
                Proudly developed through the strategic partnership between Ethiopian Airlines and Nordic ICT, 
                bringing Ethiopian audiobooks to global audiences and enhancing in-flight entertainment with cultural content.
              </p>
            </div>
            ...
            <div className="flex-shrink-0">
              <div className="bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 border border-white/30">
                <span className="text-white text-sm font-medium">Strategic Partnership</span>
              </div>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    <div className="aspect-[4/3] relative overflow-hidden">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="bg-white/90 text-gray-900 px-4 py-2 rounded-full flex items-center space-x-2 hover:bg-white hover:scale-105 transition-all duration-300 shadow-lg">
